...
reg_true_est_circ = TrueFidelityEst(prob_dist, ansatz, nqubits=3, length=150,
                                    num_shots=8192, backend=backend, init_layout=init_layout,
                                    params=vals)
...
seen_true_est_circ = TrueFidelityEst(prob_dist, ansatz, nqubits=3, length=150,
                                     num_shots=8192, backend=backend, init_layout=init_layout,
                                     params=x_seen)
...
exp_opt_true_est_circ = TrueFidelityEst(prob_dist, ansatz, nqubits=3, length=150,
                                        num_shots=8192, backend=backend, init_layout=init_layout,
                                        params=x_exp)
